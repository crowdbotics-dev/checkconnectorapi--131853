...
class Alpha123ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_ALPHA123_PASSWORD
    USERNAME = settings.CONNECTOR_ALPHA123_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_ALPHA123"
